...
<body class="gray-bg">
    ...
    <div class="header">
            <div class="logo">
                <h1><span style="color: #ffffff" <a href="#">Page not Found!</a></h1>
            </div>
    </div>
    ...
    <div class="middle-box text-center animated fadeInDown">
        ...
        <div class="error-desc">
            ...
            <br />
            <p>This page cannot be accessed right now or may have been moved to another location. Please recheck the address.</p>
            <br />
