...
<div class="ibox-content" style="font-size: 14">
    <form method="post">
        <table class="table table-bordered">
            <tbody style="font-size: 15">                
                ...
                <tr>
                    ...
                    <td style="width: 1000px">LO 1 * (15%)</td>
                    <td style="width: 1000px">LO 2 * (25%)</td>
                    <td style="width: 1000px">LO 3 * (30%)</td>
                    <td style="width: 1000px">LO 4 * (20%)</td>
                    <td style="width: 1000px">LO 5 * (10%)</td>
                </tr>
                <tr>
        ...
        <table class="table table-bordered">
            <tbody style="font-size: 15">                
                <tr>
                    <td style="width: 1000px"><strong>Mid Review Report</strong> (10%)</td>
                </tr> 
                <tr>
                    <td style="width: 1000px"></td>
                    <td style="width: 1000px">LO 1 * (5%)</td>
                    <td style="width: 1000px">LO 2 * (5%)</td>
                    <td style="width: 1000px">LO 3 * (50%)</td>
                    <td style="width: 1000px">LO 4 * (25%)</td>
