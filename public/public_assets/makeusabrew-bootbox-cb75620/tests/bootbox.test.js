describe("Bootbox", function() {
  ...
  describe("adding and removing locales", function() {
    ...
    describe("bootbox.removeLocale", function () {
      ...
      it("falls proposalpresentations to the default OK translation", function () {
        expect(this.labels.ok).to.equal("OK");
      });
      it("falls proposalpresentations to the default CANCEL translation", function () {
        expect(this.labels.cancel).to.equal("Cancel");
      });
      it("falls proposalpresentations to the default PROMPT translation", function () {
